...
> [!CAUTION]
> **本插件从逆向分析、程式码、对照表到本说明文件,100% 由 AI(Anthropic Claude)开发完成。**
> 发布者仅负责测试与提出需求。使用前请自行斟酌,问题回报欢迎开 Issue。
...
| 原版对话(只有小头像) | 装上插件后(说话者立绘) |
|---|---|
| ![原版](docs/before.jpg) | ![装上插件后](docs/after.jpg) |
...
| 项目 | 版本 |
|---|---|
| 插件版本 | v1.2.0(2026-07-05) |
| 开发/测试所用游戏版本 | Steam build **24017669**(Unity 2021.3.1f1,IL2CPP) |

游戏更新后插件可能暂时失效(游戏本体不受影响),处理方式见下方「游戏更新后」章节。
其他版本理论上相容(挂勾走类别/方法名而非位址),但未逐一验证。
